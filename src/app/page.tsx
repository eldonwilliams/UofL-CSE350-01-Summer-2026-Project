                ...
                <>
                  <Dialog>
                    ...
                    <DialogContent>
                      ...
                      <p className="bg-secondary rounded px-4 py-2 font-mono">{`${window.location.origin}/?room=${connectionData.room}`}</p>
                      <p>
                        Anyone who visits this link will be automatically
                        prompted for a username to join your active room.
                      </p>
                    </DialogContent>
                  </Dialog>
